 ...
 (function() {
     ...
     DrawingManager.prototype._bindMarker = function() {
         ...
         var clickAction = function (e) {
            ...
            // var marker = new BMap.Marker(e.point, me.markerOptions,{icon:myIcon});
            var marker = new BMap.Marker(e.point, me.markerOptions);
            map.addOverlay(marker);
             var calculate = {data:null};
             me._dispatchOverlayComplete(marker,calculate);
         }
     ...
     DrawingTool.prototype._generalHtml = function(map){
         ...
         var tips = {};
         tips["hander"]               = "拖动地图";
         tips[BMAP_DRAWING_MARKER]    = "添加设备";
         tips[BMAP_DRAWING_CIRCLE]    = "画圆";
         tips[BMAP_DRAWING_POLYLINE]  = "画折线";
         tips[BMAP_DRAWING_POLYGON]   = "添加小区";
