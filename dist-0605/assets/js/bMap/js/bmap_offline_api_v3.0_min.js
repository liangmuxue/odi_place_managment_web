...
(function() {
    ...
    z.extend(Oa.prototype, {
        ...
        fa: function() {
            ...
            ;
            a.U.Xr && (a.$.Jl = setInterval(a.Rn, 80))
        },
        Wj: function(a, b, c, e) {
        ...
        enableAutoResize: function() {
            this.U.Xr = p;
            this.Rn();
            this.$.Jl || (this.$.Jl = setInterval(this.Rn, 80))
        },
        ...
        qo: function() {
            this.U.qo = p;
            this.an || (this.an = new BuildingLayer({
                e2: p
            }),
            this.Me(this.an))
        },
        ...
        GZ: function(a) {
            ...
            this.addEventListener("hidecopyright", function() {
                c.bk.aa();
                c.U.lo = !!a.customEditor;
                c.U.lo === t && c.tE(new P(1,1))
            });
            c.bk && c.bk.aa();
            this.U.lo = !!a.customEditor;
            this.U.M4 = !!a.sharing;
            this.U.s4 = !!a.preview;
            this.U.lo === t && this.tE(new P(1,1));
            K.load("hotspot", function() {
                c.hu()
            }, p);
            window.qh = {};
    ...
    z.object.extend(K, {
        ...
        EM: function(a) {
            for (var b = 0; b < this.Pd.Vm.length; b++)
                if (this.Pd.Vm[b] == a)
                    return;
            this.Pd.Vm.push(a)
        },
    ...
    z.extend(Jc.prototype, {
        ...
        KK: function(a, b, c) {
            ...
            for (e = this.Be.length; n < e; n++)
                ...
                q.left = v + "px",
                q.top = w + "px",
                o.hn || this.QE.push([C, k, o])) : (0 < this.Oe.length ? (o = this.Oe.shift(),
        ...
        wg: function() {
            for (var a = this.lm, b = 0, c = a.length; b < c; b++)
                a[b].remove();
            delete this.hc;
            this.lm = [];
            this.Si = this.rg = {};
        ...
        kt: function(a) {
            ...
            a))
                for (var c = s, c = "2" == D.Nt ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.lm[e]; e++)
                    if (f.RZ == p) {
                        b.m.pc = 18;
    ...
    pb.prototype.getTilesUrl = function(a, b) {
        ...
        c += "&timeStamp=" + f);
        this.xf ? c += "&geotable_id=" + this.xf : this.gn && (c += "&databox_id=" + this.gn);
        return c
    }
    ;
                ...
                for (var a = a[6], k = 0; k < i.length; k++) {
                    ...
                    if (n && n.length)
                        for (var o = i[k][1], q = 0; q < o.length; q++) {
                            var v = o[q][1];
                            f.Nc(v[0], c) && (v["cache" + c] || (v["cache" + c] = f.tm(v[1], c, e, a)),
                            v = v["cache" + c],
                            f.M.Un(b.canvas.id, v, {
                                type: "polygon",
                                Ub: m,
                                style: n
                            }),
        ...
        EV: function(a, b, c, e) {
            ...
            if (!c.Ub || !(6 < e && (71013 === c.Ub || 71012 === c.Ub || 71011 === c.Ub) || 6 === e && (71011 === c.Ub || 71012 === c.Ub) || 5 === e && (71011 === c.Ub || 71013 === c.Ub) || 5 > e && (71012 === c.Ub || 71013 === c.Ub))) {
                ...
                for (var e = 2, f = b.length; e < f; e += 2)
                    a.lineTo(b[e], b[e + 1]);
                a.closePath();
                c.borderWidth && (a.strokeStyle = c.bo,
                ...
                for (var a = a[6], i = 0; i < g.length; i++) {
                    ...
                    if (m && m.length && m[0].borderWidth)
                        for (var n = g[i][1], o = 0; o < n.length; o++) {
                            var q = n[o][1];
                            f.Nc(q[0], c) && (q["cache" + c] || (q["cache" + c] = f.tm(q[1], c, e, a)),
                            q = q["cache" + c],
                            f.M.Un(b.canvas.id, q, {
                                type: "polygon",
                                Ub: k,
                                style: m
                            }),
                ...
                for (var a = a[6], i = 0; i < g.length; i++) {
                    ...
                    if (m && m.length)
                        for (var n = g[i][1], o = 0; o < n.length; o++) {
                            ...
                            if (f.Nc(q[0], c)) {
                                var v = q[2];
                                q["cache" + c] || (q["cache" + c] = f.tm(q[1], c, e, a));
                                q = q["cache" + c];
                                f.M.Un(b.canvas.id, q, {
                                    type: "polygon",
                                    Ub: k,
        ...
        FV: function(a, b, c, e) {
            ...
            if (!(c < e.filter)) {
                ...
                for (var c = 2, f = b.length; c < f; c += 2)
                    a.lineTo(b[c], b[c + 1]);
                a.closePath();
                e.borderWidth && (a.strokeStyle = e.bo,
    ...
    var md = {
        ...
        NN: function(a, b, c, e, f, g, i) {
            for (var k = 0; k < a.length; k++) {
                ...
                if (n && n.length && (!i || n[0].borderWidth))
                    if (!n[0].wo || ld(n[0].wo, b))
                        for (var o = a[k][1], q = 0; q < o.length; q++) {
                            var v = o[q][3];
                            g.Nc(v[0], b) && (v["cache" + b] || (v["cache" + b] = g.tm(v[1], b, c, f)),
                            v = v["cache" + b],
                            g.M.Un(e.canvas.id, v, {
                                type: "polyline",
                                Ub: m,
                                style: n
                            }),
                ...
                for (var a = a[6], i = 0; i < g.length; i++) {
                    ...
                    if (k && k.length)
                        for (var m = g[i][1], n = 0; n < m.length; n++) {
                            ...
                            if (f.Nc(o[0], c)) {
                                var q;
                                o["cache" + c] || (o["cache" + c] = f.tm(o[1], c, e, a));
                                q = o["cache" + c];
                                o = o[3];
        ...
        BV: function(a, b, c, e, f) {
            c = c[0];
            if (!e && c.wo && ld(c.wo, f))
                this.IV(a, b, c, ld(c.wo, f));
            else {
                a.beginPath();
                a.moveTo(b[0], b[1]);
                for (var f = 2, g = b.length; f < g; f += 2)
                    a.lineTo(b[f], b[f + 1]);
                c.borderWidth && e ? (a.strokeStyle = c.bo,
                a.lineCap = hd[c.iU],
                a.lineJoin = id[1],
                a.lineWidth = c.borderWidth / 2,
    ...
    yd.prototype = {
        bC: function(a, b, c, e, f, g, i, k, m) {
            ...
            var n = this;
            m || (m = 0);
            if (!(z.jm(window.qh) ? window.Kp : window.Tt[f]) && 100 > m)
                setTimeout(function() {
        ...
        MJ: function(a, b, c, e, f, g, i) {
            var k = this;
            i || (i = 0);
            !(z.jm(window.qh) ? window.Kp : window.Tt[g]) && 100 > i ? setTimeout(function() {
        ...
        ng: function(a, b, c, e) {
            ...
            var e = z.jm(window.qh) ? window.Kp : window.Tt[c]
              , g = f[2];
            if ("arrow" === b)
                return this.EY(g[2]);
            switch (b) {
    ...
    fa.To = function(a) {
        ...
        for (k = a.length; b < k; b++) {
            ...
            if (B)
                ...
                C.width = f + "px",
                C.height = f + "px",
                B.hn ? B.PE && B.PE && this.Fr.push(B.PE) : (B.tG = p,
                B.aB = s,
                delete B.aB,
                o.push([n, q, B]));
            else {
        ...
        if (0 === o.length) {
            ...
            for (g = 0; g < this.ow.length; g++)
                ...
                this.$E && this.Bv.cC.bC(this.Ug[i].T_, this.Ug[i].m_, this.Ug[i].Ol, this.Ug[i].zm, this.Ug[i].OD, this.Bd.Id(this.Ug[i].OD), this.Bd.XC(this.Ug[i].OD), this.$a.oD));
            this.Ug = f
        } else {
            this.Ls = o.length;
            this.ex = t;
    ...
    fa.remove = function() {
        var a = this.M.oh;
        this.Qn && a.Hg.removeChild(this.Qn)
    }
    ;
    function Kc(a) {
        this.M = a.map;
    ...
    z.extend(fb.prototype, {
        ...
        kp: function(a) {
            this.m.vk = "number" == typeof a && !isNaN(a) ? 1 > a ? fb.Dp : a > fb.Tm ? fb.Dp : a : fb.Dp
        },
        kf: function() {
            return this.m.vk
        },
    ...
    z.extend(ee.prototype, {
        ...
        kp: function(a) {
            ...
            this.m.vk = "number" !== typeof a ? ee.Tm : 1 <= a && a <= ee.Tm ? Math.round(a) : ee.Tm
        },
    ...
    z.extend(Oe, {
        fL: function(a, b, c, e) {
            if (!b || !c || !c.lngLat || !c.panoInstance)
                ...
                this.Dn === l && (this.Dn = new ec(s,{
                    hf: "api"
                }));
                var f = this;
                this.Dn.tB(b, function(b) {
                    b ? f.Dn.dj(c.lngLat, Oe.yO, function(b) {
                        if (b && b.id) {
                            var g = b.id
                              , m = b.gh
                              , b = b.hh
    ...
    function uf(a, b) {
        var c = this, e;
        c.Om = "object" == typeof a ? a : Pe.getElementById(a);
        c.Om.style.overflow = "hidden";
        c.Ob = c.Om.children[0];
        c.options = {
            Lo: p,
            Lm: p,
            x: 0,
        ...
        c.options.Zh = c.options.Lo && c.options.Zh;
        c.options.qi = c.options.Lm && c.options.qi;
    ...
    uf.prototype = {
        ...
        aS: function(a) {
            ...
            if (this.options.zoom && hf && 1 < a.touches.length)
                ...
                this.hh = b.pageY;
                if (0 < f || f < this.fe)
                    f = this.options.co ? this.x + c / 2 : 0 <= f || 0 <= this.fe ? 0 : this.fe;
                if (g > this.mf || g < this.nd)
                    g = this.options.co ? this.y + e / 2 : g >= this.mf || 0 <= this.nd ? this.mf : this.nd;
                this.XB += c;
                this.YB += e;
                ...
                if (b.Nk)
                    ...
                    if (b.fh) {
                        if (300 > k && b.options.ox) {
                            g = e ? b.qH(e - b.Dt, k, -b.x, b.Ox - b.Rt + b.x, b.options.co ? b.Rt : 0) : g;
                            i = f ? b.qH(f - b.Et, k, -b.y, 0 > b.nd ? b.gp - b.Pm + b.y - b.mf : 0, b.options.co ? b.Pm : 0) : i;
                            e = b.x + g.Fa;
                            f = b.y + i.Fa;
                        ...
                        (g.x != b.x || g.y != b.y) && b.scrollTo(g.x, g.y, g.time))) : b.Fn(200)
                    } else {
                        if (hf)
        ...
        QA: function() {
            ...
            a.Rq(f.x, f.y),
            a.Il = t,
            f.time ? a.fa(qf) : a.Fn(0)) : (i = function() {
                var k = Date.now(), m;
                if (k >= e + f.time) {
                    a.Rq(f.x, f.y);
                    a.Il = t;
        ...
        refresh: function() {
            ...
            this.Rt = this.Om.clientWidth || 1;
            this.Pm = this.Om.clientHeight || 1;
            ...
            this.nd = this.Pm - this.gp + this.mf;
            this.SB = this.RB = 0;
            this.options.mM && this.options.mM.call(this);
            this.Lo = this.options.Lo && 0 > this.fe;
            this.Lm = this.options.Lm && (!this.options.lU && !this.Lo || this.gp > this.Pm);
            this.Zh = this.Lo && this.options.Zh;
            this.qi = this.Lm && this.options.qi && this.gp > this.Pm;
            a = this.Nj(this.Om);
            this.fF = -a.left;
            this.gF = -a.top;
            if ("string" == typeof this.options.At) {
                ...
                for (this.of = []; e >= this.nd; )
                    ...
                    e -= this.Pm,
                    b++;
                this.nd % this.Pm && (this.of[this.of.length] = this.nd - this.of[this.of.length - 1] + this.of[this.of.length - 1])
            }
            this.fv("h");
            this.fv("v");
    ...
    zf.prototype = {
        ...
        refresh: function() {
            this.Bn = this.P.offsetWidth - this.fs();
            this.cA = -(this.Og.offsetWidth - this.Bn - this.ti);
        ...
        pB: function() {
            ...
            z.V(this.bg, "click", function() {
                a.scrollTo(a.Og.offsetLeft + a.Bn)
            });
        ...
        BT: function() {
            ...
            a - this.Bn <= this.cA && z.R.eb(this.Yq, "pano_arrow_disable")
        },
        scrollTo: function(a) {
            a = a < this.Og.offsetLeft ? Math.ceil((a - this.ti - this.Bn) / this.hr) * this.hr + this.Bn + this.ti - 8 : Math.ceil((a - this.ti) / this.hr) * this.hr + this.ti;
