<template>
  <div class="commit_page">
    <div class="search_box">
      ...
      <span class="search_content">
        <div class="search_content_title2">白名单范围</div>
    ...
    <div class="btn_box">
      ...
      <el-button
        ...
        @click="toDel"
        v-has="{ red: 'whiteListDelete', type: 1 }"
        >删除</el-button
      >
    </div>
        ...
        >
          <template slot-scope="scope">
            <span
              ...
              v-has="{ red: 'whiteListEdit', type: 1 }"
            >
              编辑
            </span>
            <span
              ...
              v-has="{ red: 'whiteListDetails', type: 1 }"
            >
              详情
            </span>
...
<script>
import {
  vehicleWhiteList, //白名单列表
  vehicleWhitelistBatchDelete //白名单批量删除
    ...
    toDel() {
      if (this.selGateway.length > 0) {
        ...
        this.$confirm(text, "提示", {
          ...
          vehicleWhitelistBatchDelete(para).then(response => {
