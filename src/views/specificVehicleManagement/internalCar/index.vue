<template>
  <div class="commit_page">
    <div class="search_box">
      ...
      <span class="search_content">
        <div class="search_content_title2">适用车场</div>
    ...
    <div class="btn_box">
      <el-button
        ...
        @click="toAdd"
        v-has="{ red: 'internalCarAdd', type: 1 }"
        >新增</el-button
      >
      <el-button
        type="danger"
        ...
        @click="toDel"
        v-has="{ red: 'internalCarDelete', type: 1 }"
        >删除</el-button
      >
      <el-button
        type="info"
        ...
        @click="toDownLoad"
        v-has="{ red: 'internalCarTemplate', type: 1 }"
        >模板</el-button
      >
      <el-upload
        style="margin-left:10px"
        action="String"
        :http-request="toImport"
        v-has="{ red: 'internalCarImport', type: 1 }"
      >
        <!-- <img v-if="newList.facePicFull" :src="newList.facePicFull" class="avatar" /> -->
    ...
    <div class="content_box">
      ...
      >
        ...
        <el-table-column label="车牌颜色" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span class="content">{{ scope.row.licenseColorName }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="车主手机" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span class="content">{{ scope.row.phoneNumber }}</span>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <span
              ...
              v-has="{ red: 'internalCarEdit', type: 1 }"
            >
              编辑
            </span>
            <span
              ...
              v-has="{ red: 'internalCarDetails', type: 1 }"
            >
              详情
            </span>
...
export default {
  ...
  methods: {
    ...
    toDownLoad() {
      ...
      //   currentPage: 1,
      //   pageSize: 1000,
      //   visitorName: this.listQuery.visitorName,
      //   targetPeopleName: this.listQuery.targetPeopleName,
      //   visitStart: this.listQuery.visitStart,
      //   visitEnd: this.listQuery.visitEnd,
      //   visitorMobile: this.listQuery.visitorMobile,
      //   createdTimeStart: this.listQuery.createdTimeStart,
      //   createdTimeEnd: this.listQuery.createdTimeEnd,
      //   visitReason: this.listQuery.visitReason,
    ...
    toImport(data) {
      ...
      // importData(formData, this.tenantId)
      //   .then(response => {
    ...
    toDel() {
      if (this.selGateway.length > 0) {
        ...
        this.$confirm(text, "提示", {
          ...
          internalCarDelete(para).then(response => {
