  ...
  <div class="commit_page">
    <div class="search_box">
      ...
      <span class="search_content">
        ...
        <el-select
          v-model="listQuery.ruleVehicleType"
          placeholder="选择车辆类型"
          clearable
          class="filter-item"
          style="width: 72%"
      ...
      <span class="search_content">
        <div class="search_content_title">车位类型</div>
        <el-select
          v-model="listQuery.ruleParkingDirection"
          placeholder="选择车位类型"
          clearable
          class="filter-item"
          style="width: 72%"
    ...
    <div class="content_box">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span class="content">{{ scope.row.unitPrice }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="单次购买上限(个)"
        ...
        <el-table-column label="车辆类型" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span class="content">{{ scope.row.ruleVehicleTypeName }}</span>
          </template>
        </el-table-column>
        <el-table-column label="车位类型" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span class="content">{{
