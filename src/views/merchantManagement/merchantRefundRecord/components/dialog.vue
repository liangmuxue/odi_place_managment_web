          ...
          <div class="base_dialog_main_left" style="padding: 40px 80px">
            ...
            <span class="base_dialog_condit">
              <el-form-item label="实退金额(元)">
                <span class="base_dialog_condit_text">
                  {{ detail.amountActuality | getMoney }}
                </span>
              </el-form-item>
            </span>
            <span class="base_dialog_condit">
...
<script>
import { merchantRefundRecordDetail } from "@/api/merchantManagement";
...
export default {
  ...
  methods: {
    showDialog(id) {
      ...
      this.isShow = true;
      const para = { merchantRefundId: id };
      merchantRefundRecordDetail(para)
        .then(response => {
